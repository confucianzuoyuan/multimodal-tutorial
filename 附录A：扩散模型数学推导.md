...
$$
q(x_{t},x_{t-1}) = q(x_{t}|x_{t-1})q(x_{t-1}) = q(x_{t-1}|x_{t})q(x_{t})
$$

贝叶斯公式

$$
q(x_{t-1}|x_{t}) = \frac{q(x_{t}|x_{t-1})q(x_{t})}{q(x_{t-1})}
$$
...
威廉费勒证明了，只要时间步足够小，那么反向马尔可夫过程也是一个正态分布。
```
...
这里我们可以优化 **变分下界** ，而不是优化难以解决的损失函数本身。
